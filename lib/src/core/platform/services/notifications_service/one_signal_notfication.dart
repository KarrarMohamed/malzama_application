...
class NotificationService {
  ...
  final String _oneSignalAppId = '5b72561c-a064-4938-b250-fbda4707e35d';
    ...
    OneSignal.shared.setNotificationReceivedHandler(
      (OSNotification notification) {
        ...
        NotificationStateProvider notificationStateProvider =
            locator.get<NotificationStateProvider>();
        ...
        try {
          receivedNotification = new NotificationInstance(
            ...
            sentAt: DateTime.fromMillisecondsSinceEpoch(
                notification.payload.rawPayload['google.sent_time']),
          );
          notificationStateProvider
              .addToNotificationsList(receivedNotification);
        } catch (err) {
          throw err;
        }
      },
  ...
  while (userId == null) {
    ...
    if (userId != null) {
      ...
      await CachingServices.saveStringField(
          key: 'one_signal_id', value: userId);
      print(
          '************************************************************************');

...
import 'package:malzama_app/src/features/home/presentation/pages/my_materials/materialPage/quizes/quiz_draft_model.dart';
...
class QuizAccessObject {
  ...
  Future<int> getUploadedMaterialCount(String storeName)async{
    var res = await intMapStoreFactory.store(storeName).find(await this.database);
    return res.length;
  }

...
import 'package:malzama_app/src/core/general_widgets/helper_utils/profile_pictures_modal_sheet.dart';
import 'package:malzama_app/src/core/platform/services/dialog_services/service_locator.dart';
import 'package:malzama_app/src/core/platform/services/file_system_services.dart';
import 'package:malzama_app/src/features/home/models/users/college_student.dart';
import 'package:malzama_app/src/features/home/models/users/college_teacher.dart';
import 'package:malzama_app/src/features/home/models/users/college_user.dart';
import 'package:malzama_app/src/features/home/models/users/school_student.dart';
import 'package:malzama_app/src/features/home/models/users/school_teacher.dart';
import 'package:malzama_app/src/features/home/models/users/school_user.dart';
...
import 'package:malzama_app/src/features/home/presentation/pages/my_materials/my_saved_and_uploads/my_saved_material/state_provider/saved_pdf_state_provider.dart';
import 'package:malzama_app/src/features/home/presentation/pages/my_materials/my_saved_and_uploads/my_saved_material/state_provider/saved_quizes_state_provider.dart';
...
import 'package:malzama_app/src/features/home/presentation/pages/shared/accessory_widgets/bio_options_widget.dart';
import 'package:malzama_app/src/features/home/presentation/pages/shared/accessory_widgets/yes_or_no_alert_dialog.dart';
...
class HelperFucntions {
  ...
  static Future<Map<String, dynamic>> getAuthorPopulatedData() async {
    User data = locator<UserInfoStateProvider>().userData;
    print('=========================== inside getAuthorPopulated Data');
    print('=' * 80);
    print(data?.toJSON() ?? null);
    print('=' * 80);
    var populatedData = {
...
//  }
  ...
  static Future<String> uploadPDFToCloud(File pdf) async {
    ...
    TaskSnapshot snapshot = await storage.ref().child('school_pdfs/$pdfName.pdf').putFile(pdf).catchError((err) {
      print('error');
      print(err);
      print('error');
    });

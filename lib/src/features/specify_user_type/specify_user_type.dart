...
import 'package:malzama_app/src/core/references/references.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ListTile(
              ...
              onTap: () async {
                await _navigateToCollegePostSignupPage(context, AccountType.uniteachers);
              },
            ),
            ListTile(
              leading: FaIcon(
              ...
              onTap: () async {
                _navigateToCollegePostSignupPage(context, AccountType.unistudents);
              },
            ),
          ],
        ),
...
Future<void> _navigateToCollegePostSignupPage(BuildContext context, String accountType) async {
  print('from inside the specify user type  ' + accountType);
  print('below from insdide above ${AccountType.unistudents}');
  await CachingServices.saveStringField(key: 'accountType', value: '$accountType');
...
Future<void> _navigateToSchoolPostSignUpPage(BuildContext context, String accountType) async {
  print('from inside the specify user type  ' + accountType);
  await CachingServices.saveStringField(key: 'accountType', value: '$accountType');
  print('after saving cache');
  print('$accountType');

...
class CollegeUploadedQuizHoldingWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    MyUploadsStateProvider myUploadsStateProvider =
        Provider.of<MyUploadsStateProvider>(context, listen: false);
    ...
    return InkWell(
      onTap: () {
        ...
        Navigator.of(context)
            .pushNamed(RouteNames.TAKE_QUIZ_EXAM, arguments: args);
      },
      child: Card(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Selector<MyUploadsStateProvider, String>(
        selector: (_, stateProvider) =>
            stateProvider.uploadedQuizes[pos].credentials.description,
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Padding(
                ...
                child: Selector<MyUploadsStateProvider, int>(
                  selector: (context, stateProvider) =>
                      stateProvider.uploadedQuizes[pos].questionsCount,
              ...
              FlatButton(
                onPressed: () async {
                  final String action =
                      await HelperFucntions.showEditOrDeleteModalSheet(
                    context: context,
                  );
                  if (action == null) {
          ...
          Padding(
            ...
            child: Selector<MyUploadsStateProvider, String>(
              selector: (context, stateProvider) =>
                  stateProvider.uploadedQuizes[pos].credentials.title,
          ...
          Padding(
            ...
            child: Text('Published in: ' +
                myUploadsStateProvider.uploadedQuizes[pos].postDate
                    .substring(0, 10)
                    .toString()),
          ),
          if (myUploadsStateProvider.uploadedQuizes[pos].lastUpdate != null)
            Padding(
              ...
              child: Selector<MyUploadsStateProvider, String>(
                selector: (_, stateProvider) =>
                    stateProvider.uploadedQuizes[pos].lastUpdate,
                builder: (_, lastUpdate, __) =>
                    Text('Last update:${lastUpdate.substring(0, 10)}'),
              ),
            ),
        ],
      ),
...
class _UploadedQuizFooter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String semester =
        (Provider.of<MyUploadsStateProvider>(context, listen: false)
                .uploadedLectures[pos] as CollegeMaterial)
            .semester
            .toString();
              ...
              child: Column(
                ...
                children: <Widget>[
                  Selector<MyUploadsStateProvider, int>(
                    selector: (context, stateProvider) =>
                        stateProvider.uploadedLectures[pos].stage,
                  ...
                  if (semester != 'unknown')
                    Selector<MyUploadsStateProvider, int>(
                      selector: (context, stateProvider) => (stateProvider
                              .uploadedLectures[pos] as CollegeMaterial)
                          .semester,

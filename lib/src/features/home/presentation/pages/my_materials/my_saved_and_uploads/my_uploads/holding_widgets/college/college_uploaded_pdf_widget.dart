...
class CollegeUploadedPDFHoldingWidget extends StatelessWidget {
  final int pos;

  const CollegeUploadedPDFHoldingWidget({
    @required this.pos,
  });
        ...
        children: [
          ...
          FlatButton(
            onPressed: () async {
              ...
              val == 'edit' ? myUploadsStateProvider.onMaterialEdit(context,pos,false) : myUploadsStateProvider.onMaterialDelete(context,
                  pos, 'lectures');
            },

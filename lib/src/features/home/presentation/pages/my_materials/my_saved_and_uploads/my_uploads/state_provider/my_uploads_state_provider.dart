...
import 'package:malzama_app/src/core/api/api_client/clients/common_materials_client.dart';
import 'package:malzama_app/src/core/api/contract_response.dart';
import 'package:malzama_app/src/core/platform/local_database/access_objects/quiz_access_object.dart';
import 'package:malzama_app/src/core/platform/services/dialog_services/dialog_service.dart';
...
import 'package:malzama_app/src/features/home/presentation/pages/my_materials/materialPage/state_provider_contracts/my_saved_and_uploads_contract.dart';
...
// =========================================================================================================================================
  ...
  StudyMaterial _jsonParser(data) {
    return CollegeMaterial.fromJSON(data);
  }
...
// =========================================================================================================================================
  ...
  Future<void> onQuizDelete(BuildContext context, int pos) async {
    ...
    final String collectionName = 'uniquizes';
  ...
  Future<void> onMaterialDelete(BuildContext context, int pos, String materialName) async {
    locator<DialogService>().showDialogOfLoading(message: 'deleting ....');
    final String collectionName = 'uni$materialName';
  ...
  Future<void> onMaterialEdit(BuildContext context, int pos, bool isVideo) async {
    ...
    final String routeName = RouteNames.EDIT_COLLEGE_MATERIAL;

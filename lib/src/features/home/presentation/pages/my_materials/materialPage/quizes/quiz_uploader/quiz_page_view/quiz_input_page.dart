                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          initialValue: uploadingState
                              ...
                              ? null
                              : uploadingState.quizList[widget.pos].options[0],
                          maxLines: null,
                          decoration: InputDecoration(
                            hintText: 'Option A',
                            border: OutlineInputBorder(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          initialValue: uploadingState
                                  .quizList[widget.pos].options.isEmpty
                              ? ''
                              : uploadingState.quizList[widget.pos].options[1],
                          maxLines: null,
                          decoration: InputDecoration(
                            hintText: 'Option B',
                            border: OutlineInputBorder(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          initialValue: uploadingState
                                  .quizList[widget.pos].options.isEmpty
                              ? ''
                              : uploadingState.quizList[widget.pos].options[2],
                          maxLines: null,
                          decoration: InputDecoration(
                            hintText: 'Option C',
                            border: OutlineInputBorder(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          initialValue: uploadingState
                                  .quizList[widget.pos].options.isEmpty
                              ? ''
                              : uploadingState.quizList[widget.pos].options[3],
                          maxLines: null,
                          decoration: InputDecoration(
                            hintText: 'Option D',
                            border: OutlineInputBorder(

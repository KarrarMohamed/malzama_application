...
class _QuizBodyState extends State<QuizBody> {
  ...
  Widget build(BuildContext context) {
    ...
    String mainText =
        '$text $text $text $text Ophthalmic solutions should be formulated to include which ';
    ScreenUtil.init(context);
    return Container(
      color: Colors.white,
  ...
  BoxConstraints getBoxConstraints(
      bool isExpanded, String text, double minHeight, double maxHeight) {
    if (isExpanded) {

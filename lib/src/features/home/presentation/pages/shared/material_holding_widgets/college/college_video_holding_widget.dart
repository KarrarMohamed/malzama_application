...
class CollegeVideoHoldingWidget<T extends MaterialStateRepository>
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context)
            .pushNamed(RouteNames.VIEW_VIDEO_DETAILS, arguments: pos);
      },
      child: Padding(
...
class UpperPart<T extends MaterialStateRepository> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isMyVideo =
        userInfo.userData.id == videoState.materials[pos].author.id;
    ScreenUtil.init(context);
    return Container(
      child: Row(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  if (semester != 'unknown' && semester != 'null')
                    Selector<B, int>(
                      selector: (context, stateProvider) =>

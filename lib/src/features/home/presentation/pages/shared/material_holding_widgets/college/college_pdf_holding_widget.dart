...
class CollegePDFHoldingWidget<T extends MaterialStateRepository>
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Selector<T, String>(
                          ...
                          stateProvider.materials[pos].title,
                      ...
                      Padding(
                        ...
                        child: Selector<T, String>(
                          selector: (context, stateProvider) =>
                          stateProvider.materials[pos].description,
...
class Header<T extends MaterialStateRepository> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isMyMaterial =
        userInfoState.userData.id == pdfStateProvider.materials[pos].author.id;
    final String postDate =
        pdfStateProvider.materials[pos].postDate.substring(0, 10);
    ScreenUtil.init(context);
    return Container(
      padding: EdgeInsets.all(ScreenUtil().setSp(20)),
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Selector<T, String>(
                selector: (context, T stateProvider) =>
                stateProvider.materials[pos].lastUpdate,
          ...
          if (!isMyMaterial)
            Selector<T, bool>(
              selector: (context, stateProvider) =>
              stateProvider.materials[pos].isSaved,
              builder: (context, isSaved, _) => GestureDetector(
                child: Icon(
                  isSaved ? Icons.bookmark : Icons.bookmark_border,
                  color: Colors.black,
                ),
                onTap: () => HelperFucntions.onPdforVideoSaving<T>(
...
class _Footer<B extends MaterialStateRepository> extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final String semester = (Provider.of<B>(context, listen: false)
            .materials[pos] as CollegeMaterial)
        .semester
        .toString();
    final Size screenSize = MediaQuery.of(context).size;
    ScreenUtil.init(context);
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  if (semester != 'unknown')
                    Selector<B, int>(
                      selector: (context, stateProvider) =>
                      (stateProvider.materials[pos] as CollegeMaterial)
                          .semester,
...
Widget userAvatar({BuildContext context, String imageUrl}) {
  ScreenUtil.init(context);
  return Container(

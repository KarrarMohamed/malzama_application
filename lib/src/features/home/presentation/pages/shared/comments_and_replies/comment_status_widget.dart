                ...
                FlatButton(
                  ...
                  onPressed: () async {
                    ...
                    if (withinReply && !mainComment) {
                      final String replyContent = commentStateProvider.comments[commentPos].replies[replyPos].content;
                      commentStateProvider.uploadNewReply(content: replyContent, replyPos: replyPos, resend: true);
                      return;
                    }
                    final String commentContent = commentStateProvider.comments[commentPos].content;
                    commentStateProvider.uplaodNewComment(content: commentContent, resend: true, pos: commentPos);
                  },
                ),
              ],
            );

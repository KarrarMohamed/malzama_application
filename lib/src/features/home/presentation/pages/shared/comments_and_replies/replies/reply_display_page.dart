...
class ReplyDisplayPage<B extends MaterialStateRepository>
    extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final Size screenSize = MediaQuery.of(context).size;

    CommentStateProvider<B> commentStateProvider =
        Provider.of<CommentStateProvider<B>>(context, listen: false);
            ...
            children: <Widget>[
              ...
              Expanded(
                child: Selector<CommentStateProvider<B>, int>(
                  selector: (context, stateProvider) =>
                  stateProvider
                      .comments[commentStateProvider
                      .repliesRelevantCommentPos]
                      .replies
                      .length +
                      1,
                  builder: (context, repliesCount, child) =>
                      ListView.builder(
                        ...
                        itemBuilder: (context, pos) {
                          ...
                          return Padding(
                            ...
                            child: CommentWidget<B>(
                              commentPos: commentStateProvider
                                  .repliesRelevantCommentPos,
                              withinReply: true,
                              replyPos: pos - 1,
                            ),

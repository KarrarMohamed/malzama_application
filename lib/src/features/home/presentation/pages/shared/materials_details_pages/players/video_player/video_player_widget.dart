...
import 'package:malzama_app/src/features/home/presentation/pages/videos/videos_navigator/state/videos_player_state_provider.dart';
...
class VideoPlayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<VideosPlayerStateProvider, bool>(
      ...
      builder: (context, isLoading, _) =>  YoutubePlayer(controller: playerStateProvider.youTubePlayerController) ??WillPopScope(

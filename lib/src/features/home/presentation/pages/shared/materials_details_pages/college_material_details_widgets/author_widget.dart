...
class CollegeMaterialDetailsAuthorWidget<B extends MaterialStateRepository>
        ...
        children: [
            ...
            children: [
              Selector<B, List<String>>(
                ...
                builder: (context, data, _) =>
                    Text('By ${data.first} ${data.last}'),
              ),
              if (HelperFucntions.isTeacher(
                  materialStateRepo.materials[pos].author.accountType))
                Selector<B, String>(
                  selector: (context, stateProvider) =>
                  stateProvider.materials[pos].author.speciality,
          ...
          Column(
            ...
            children: [
              ...
              if (false ||
                  (Provider.of<B>(context, listen: false).materials[pos]
                  as CollegeMaterial)
                      ?.semester !=
                      null)
                Selector<B, int>(
